...
class LoanImpacts:
    ...
    def compute_impacts(self):
        ...
        table.append(['Index','InterestPaid','Duration','MIInterest','MIDuration'])
        print(f'ALL \t\t',
        ...
        # table.append([round(loan_none.total_interest_paid, 2),loan_none.time_to_loan_termination,round(micro_impact_interest_paid_all, 4),round(micro_impact_duration_all, 4)])
        ...
        for index, contribution in enumerate(self.contributions):
            ...
            table.append([index+1, round(loan_none.total_interest_paid, 2), loan_none.time_to_loan_termination,
